...
static constexpr float                  ALT_ARM_THRESHOLD               = 3.0F;         // Altitude to arm ejection system
static constexpr float                  ALT_CONTINGENCY_START           = 10.0F;        // Altitude to begin contingency countdown
static constexpr float                  ALT_DEPLOY_THRESHOLD            = 600.0F;       // Normal deployment altitude
static constexpr float                  ALT_RESET_THRESHOLD             = 2.0F;         // Altitude below which to reset and stop logging
...
static constexpr unsigned long          TIME_BASED_EJECTION_MS          = 8000UL;       // Contingency timer duration
...
uint8_t                                 mainDeploymentAltitude          = 250;            // Descent deployment altitude (in meters) for the main parachute
...
static constexpr unsigned long          FIRE_DURATION_MS                = 350; // Duration for firing pyro pin
